...
**Explanation (EN)**
This node analyzes **Gibbs Free Energy** within hydrogen science. Equation reuse across the corpus
adds structural weight to the knowledge lattice. Reuse count: **88**.
...
**用語:** Gibbs Free Energy

**数式**
$$ \text{Derived} $$

**説明（JP）**
この研究ノードは水素科学における **Gibbs Free Energy** を解析します。
...
---
Generated: 2025-12-13T06:57:15.396657 UTC
