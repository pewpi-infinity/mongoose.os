...
SITES_FILE = "sites_cart101_physics.txt"
SCRAPE_DIR = "scraped_cart101_physics"
OUT_DIR = "tokens_cart101_physics"
...
def main():
    ...
    for term in TERMS:
        ...
        # token value from size + http counts
        token_value = 0
        raw_agg = []
        ...
        ## Token #: {token_num}
        ## Token Value: {token_value}  (based on bytes + http link counts across scraped files)
        ...
        The valuation is not based on price or opinion, but on the *density of
        information* available to the Infinity OS across this repo and Termux
        environment. The number {token_value} is a proxy for "links + text mass"
        available to be recombined into higher-order Infinity research.
